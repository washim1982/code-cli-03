...
_RULES = (
    ...
    "- To create a file with real content, use generate_file with a one-sentence "
    "'spec'. The content is produced in a separate step, so it does not have to "
    "fit inside this reply.\n"
